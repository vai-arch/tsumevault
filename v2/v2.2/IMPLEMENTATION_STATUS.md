...
- 3.12 Otros — resumeRun de un run completado corregido (no se rejuega: cierra, avisa y no entra en modo run; cubre runs de review sin run_items). Pendientes: bare columns, PK de run_items, resolución de segundo, SFX iOS, AE en setup.
